...
const QuoteCTA = () => (
  <section className="py-20 bg-gradient-soft border-y border-border/60">
    <div className="container">
      <ScrollReveal variant="floatUp" className="text-center max-w-2xl mx-auto mb-12">
      ...
      <StaggerContainer className="grid md:grid-cols-3 gap-6 mb-10" stagger={0.14}>
        {steps.map(({ icon: Icon, title, desc }, i) => (
          <StaggerItem key={title} variant="scaleUp">
            <div className="relative bg-card rounded-2xl p-6 shadow-elegant border border-border/60 hover:shadow-float transition-smooth">
      ...
      <ScrollReveal variant="fadeBlur" delay={0.3} className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        <a
          href="#contacto"
